...
<h2>List of Performers</h2>
   ...
   <tr>
     <td><?php echo json_encode($my_var2[0]); ?></td>
     <td><?php echo json_encode($my_var[0]); ?></td>
   </tr>
   <td><?php echo json_encode($my_var2[1]); ?></td>
   <td><?php echo json_encode($my_var[1]); ?></td>
   <tr>
     <td><?php echo json_encode($my_var2[2]); ?></td>
     <td><?php echo json_encode($my_var[2]); ?></td>
   </tr>
 </table>
</body>
